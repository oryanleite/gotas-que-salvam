...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) { return <html lang="pt-BR"><body>{children}<Toaster position="bottom-center" richColors/><Analytics/></body></html>; }
